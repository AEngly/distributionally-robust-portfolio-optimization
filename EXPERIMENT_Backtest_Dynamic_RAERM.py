...
Date: 15-01-2024
Description: This file backtests the Wasserstein-based DRO of RAERM model used in the thesis.
...
dataFrameTrajectoryDates.to_csv("./Results/Backtest/RAERM/TrajectoryDates.csv", index=False)

# Save Wasserstein parameters
dataFrameRebalanceDates = pd.DataFrame(rebalanceDates, columns=["Dates"])
dataFrameRebalanceDates.to_csv("./Results/Backtest/RAERM/RebalanceDates.csv", index=False)
...
# Save results
write_parameters_to_file(trajectories.reshape(-1), parameters, file_name="Backtest_RAERM_Trajectories", folder_path="./Results/Backtest/RAERM/", expId=1)

# Create logging string
line0 = "fileName: " + "Backtest_RAERM_Wasserstein" + "\n"
line1 = "alpha: {}".format(excessReturnAnually) + "\n"
line2 = "nEps: " + str(len(epsCollection)) + "\n"
line3 = "nBetas: " + str(len(betaCollection)) + "\n"
line4 = "nRhos: " + str(len(rhoCollection)) + "\n"
...
# Save results
write_parameters_to_file(epsOpt.reshape(-1), parameters, file_name="Backtest_RAERM_Wasserstein", folder_path="./Results/Backtest/RAERM/", expId=1)

# Create logging string
line0 = "fileName: " + "Backtest_RAERM_trajectories" + "\n"
line1 = "alpha: {}".format(excessReturnAnually) + "\n"
line2 = "nEps: " + str(len(epsCollection)) + "\n"
line3 = "nBetas: " + str(len(betaCollection)) + "\n"
line4 = "nRhos: " + str(len(rhoCollection)) + "\n"
...
# Create logging string
line0 = "fileName: " + "Backtest_RAERM_epsOpt" + "\n"
line1 = "alpha: {}".format(excessReturnAnually) + "\n"
line2 = "nEps: " + str(len(epsCollection)) + "\n"
line3 = "nBetas: " + str(len(betaCollection)) + "\n"
line4 = "nRhos: " + str(len(rhoCollection)) + "\n"
...
# Save results
write_parameters_to_file(epsOpt, parameters, file_name="Backtest_RAERM_epsOpt", folder_path="./Results/Backtest/RAERM/", expId=1)

# Save statistics

# Create logging string
line0 = "fileName: " + "Backtest_RAERM_IS_statistics" + "\n"
line1 = "alpha: {}".format(excessReturnAnually) + "\n"
line2 = "nEps: " + str(len(epsCollection)) + "\n"
line3 = "nBetas: " + str(len(betaCollection)) + "\n"
line4 = "nRhos: " + str(len(rhoCollection)) + "\n"
...
# Save results
write_parameters_to_file(IS_statistics.reshape(-1), parameters, file_name="Backtest_RAERM_IS_statistics", folder_path="./Results/Backtest/RAERM/", expId=1)

# Create logging string
line0 = "fileName: " + "Backtest_RAERM_OoS_statistics" + "\n"
line1 = "alpha: {}".format(excessReturnAnually) + "\n"
line2 = "nEps: " + str(len(epsCollection)) + "\n"
line3 = "nBetas: " + str(len(betaCollection)) + "\n"
line4 = "nRhos: " + str(len(rhoCollection)) + "\n"
...
# Save results
write_parameters_to_file(OoS_statistics.reshape(-1), parameters, file_name="Backtest_RAERM_OoS_statistics", folder_path="./Results/Backtest/RAERM/", expId=1)