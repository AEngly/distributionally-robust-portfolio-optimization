...
# Create logging string
line0 = "fileName: " + "Frontier_Backtest_ITM_epsOpt" + "\n"
line1 = "alpha: {}".format(excessReturnAnually) + "\n"
line2 = "nEps: " + str(len(epsCollection)) + "\n"
line3 = "nBetas: " + str(len(betaCollection)) + "\n"
line4 = "nRhos: " + str(len(rhoCollection)) + "\n"
...
# Create logging string
line0 = "fileName: " + "Frontier_Backtest_ITM_IS_statistics" + "\n"
line1 = "alpha: {}".format(excessReturnAnually) + "\n"
line2 = "nEps: " + str(len(epsCollection)) + "\n"
line3 = "nBetas: " + str(len(betaCollection)) + "\n"
line4 = "nRhos: " + str(len(rhoCollection)) + "\n"
...
# Save results
write_parameters_to_file(IS_statistics.reshape(-1), parameters, file_name="Frontier_Backtest_ITM_IS_statistics", folder_path="./Results/Backtest/ITM/", expId=1)

# Create logging string
line0 = "fileName: " + "Frontier_Backtest_ITM_OoS_statistics" + "\n"
line1 = "alpha: {}".format(excessReturnAnually) + "\n"
line2 = "nEps: " + str(len(epsCollection)) + "\n"
line3 = "nBetas: " + str(len(betaCollection)) + "\n"
line4 = "nRhos: " + str(len(rhoCollection)) + "\n"
...
# Save results
write_parameters_to_file(OoS_statistics.reshape(-1), parameters, file_name="Frontier_Backtest_ITM_OoS_statistics", folder_path="./Results/Backtest/ITM/", expId=1)